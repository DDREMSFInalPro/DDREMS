...
Payment.belongsTo(Agreement, { foreignKey: "agreement_id", as: "agreement" });
...
FormalAgreement.belongsTo(User, { foreignKey: "owner_id", as: "ownerUser" });
FormalAgreement.belongsTo(User, { foreignKey: "buyer_id", as: "buyer" });
