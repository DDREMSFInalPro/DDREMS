...
const AgreementDetailPage = () => {
  ...
  const handleConfirmPayment = async () => {
    if (
      !window.confirm(
        "Confirm that you have received the payment from the buyer?",
      )
    )
      return;
    setActionLoading(true);
  ...
  return (
    <div className="agreement-detail-page">
        ...
        >
          ...
          <div className="card__body">
            {payment ? (
              <>
                <p>
                  <strong>Payment Method:</strong> {payment.paymentGateway}
                </p>
                <p>
            ...
            <p style={{ marginTop: "1rem", color: "#6b7280" }}>
              Please review the receipt above and confirm if you have received
              this payment.
            </p>
            <button
      ...
      {/* Formal Agreement section — shown once admin creates it */}
          ...
          <div className="card__body">
            <p style={{ marginBottom: "1rem" }}>
              {agreement.status === "completed"
                ...
                : "The admin has created a formal agreement. Please review and sign it."}
            </p>
            <button
            ...
            <div className="card__body">
              <div className="alert alert--info">
                ...
                {agreement.status === "payment_confirmed" &&
                  "✅ You confirmed payment received. Admin is verifying..."}
              </div>
            </div>
          </div>
        )}
