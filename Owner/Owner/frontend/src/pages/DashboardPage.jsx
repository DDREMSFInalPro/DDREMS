                ...
                <tbody>
                  {recentProperties.map((prop) => (
                    <tr key={prop.id}>
                      ...
                      <td>
                        <span className={`badge badge--${prop.isPublished ? 'success' : ['sold','rented'].includes(prop.status) ? 'danger' : 'warning'}`}>
                          {['sold','rented'].includes(prop.status) ? prop.status.toUpperCase() : prop.isPublished ? 'Published' : prop.status}
                        </span>
                      </td>
                    </tr>
                  ))}
