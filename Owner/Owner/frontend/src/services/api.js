...
export const agreementAPI = {
  ...
  confirmPayment: (id, data) => api.patch(`/agreements/${id}/confirm-payment`, data),
};
...
export const documentAPI = {
  upload: (propertyId, formData) => api.post(`/documents/${propertyId}`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' },
  }),
  getAll: (propertyId) => api.get(`/documents/${propertyId}`),
  getDownloadUrl: (documentId, accessKey) => `/api/documents/download/${documentId}?key=${accessKey}`,
