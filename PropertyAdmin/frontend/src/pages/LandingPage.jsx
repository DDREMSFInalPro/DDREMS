    ...
    <div className="landing">
      ...
      <section className="landing__hero" id="hero">
        ...
        <div className="landing__hero-left">
          <h1>Administer Dire Dawa<br />Real Estate System</h1>
          <p>Manage Properties, Users, Agreements & Payments</p>
          <div className="landing__features-list">
            <div className="landing__feature-item">👥 Manage users & roles</div>
            <div className="landing__feature-item">🏠 Review & publish properties</div>
            <div className="landing__feature-item">📄 Process agreement workflows</div>
            <div className="landing__feature-item">💳 Verify payments & generate PDFs</div>
          </div>
        </div>
        ...
        <div className="landing__login-card">
          ...
          <p className="landing__register-link">Administrator access only</p>
        </div>
      </section>
    </div>
  );
