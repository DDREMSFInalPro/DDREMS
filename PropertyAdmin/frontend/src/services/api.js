...
export const agreementAPI = {
  ...
  sendCounterOfferToBuyer: (id, data) =>
    api.patch(`/agreements/${id}/send-counter-offer`, data),
  forwardBuyerCounterToOwner: (id, data) =>
    api.patch(`/agreements/${id}/forward-buyer-counter`, data),
  approveBuyerAcceptance: (id, data) =>
    api.patch(`/agreements/${id}/approve-buyer-acceptance`, data),
  askOwnerPayment: (id, data) =>
    api.patch(`/agreements/${id}/ask-owner-payment`, data),
  verifyPayment: (id) => api.patch(`/agreements/${id}/verify-payment`, {}),
};

export const formalAgreementAPI = {
  getAll: (params) => api.get("/formal-agreements", { params }),
  ...
  create: (data) => api.post("/formal-agreements", data),
  verifyPayment: (id) => api.patch(`/formal-agreements/${id}/verify-payment`),
  generatePDF: (id) => api.post(`/formal-agreements/${id}/generate-pdf`),
};
