...
module.exports = (sequelize) => {
  const Agreement = sequelize.define(
    "Agreement",
    {
      ...
      buyerId: { type: DataTypes.UUID, allowNull: true, field: "buyer_id" },
      clientName: {
        type: DataTypes.STRING(150),
        allowNull: false,
        field: "client_name",
      },
      clientEmail: { type: DataTypes.STRING(150), field: "client_email" },
      clientPhone: { type: DataTypes.STRING(20), field: "client_phone" },
      agreementType: {
      ...
      monthlyRent: { type: DataTypes.DECIMAL(15, 2), field: "monthly_rent" },
      salePrice: { type: DataTypes.DECIMAL(15, 2), field: "sale_price" },
